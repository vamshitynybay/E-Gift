...
public partial class Browse_frmProductDetails : System.Web.UI.Page
{
    ...
    protected void btnBuy_Click1(object sender, EventArgs e)
    {
        ...
        Response.Redirect("/EGiftShopee/Cart/frmShoppingCart.aspx");
    }
   
    
    protected void btnRefer_Click(object sender, EventArgs e)
    {
        Response.Redirect("/EGiftShopee/Browse/frmrefertofriend.aspx");
    }
    ...
    {
        Response.Redirect("/EGiftShopee/Browse/frmRating.aspx?PID=" + Request["PID"].ToString());
    }
