...
<asp:DataList  ID="dlOrders"  runat="server" Width="100%" CellPadding="4" ForeColor="#333333">
    ...
    <td style="width:7%">
    <img src='<%#DataBinder.Eval(Container.DataItem,"ProductImage","/EGiftShopee/Browse/Images/{0}")%>' alt='<%#DataBinder.Eval(Container.DataItem,"ProductName")%>' width="30" height="30" />
    </td>
    <td style="width:7%"> 
